...
namespace Examen2ParcialRaulRivera.Controladores
{
    public class EstadoTicketController
    {
        ...
        private void Eliminar(object serder, EventArgs e)
        {
            ...
            {
                bool elimino = estadoDAO.EliminarEstado(Convert.ToInt32(vista.EstadoTicketDataGridView.CurrentRow.Cells[0].Value.ToString()));
        ...
        {
            vista.EstadoTicketDataGridView.DataSource = estadoDAO.GetEstado();
        }
